...
class AvisoController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','addCategoriaForm'),
				'users'=>array('*'),
			),
	...
	public function actionAddCategoriaForm()
    {
		...
		if($id == 7 ){
		 $model = new Auto();
		 $url = 'application.views.auto._form';
		}
		
		if($url != null){
		   $url2 = $this->renderPartial($url, array('model'=>$model),true);
		}else{
		    $url2 = false;
		}
